...
%TODO one sentence about the algorithm here. + a citation to the algorithm.
We present also an evaluation of the solution's performance ... 
%TODO the sentence above needs a better ending!

%%% Cleanup: Leif Arne's abstract:
Solving the CRA problem using java and atl. 
Java is used to evaluate and compare class diagrams, and to call atl programmatically. 
Atl is used to transform the class diagrams. 
The best solution is determined by simulated annealing, a local search algorithm.
\end{abstract}
